...
The [intended audiobook migration](../hoki-audiobook/BUILD-DEPS.md#intended-production-build-not-yet-implemented)
...
including UI, BLE SSH, acoustic-link, health-recorder, and Android GPS helpers.
...
| hoki-powerd, hoki-radiod, hoki-hwc-proxy, asteroid-compositor | Existing shell services in `hoki-ui` |
